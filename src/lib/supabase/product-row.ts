...
export const PRODUCT_LIST_SELECT =
  "id, title, price, original_price, condition, free_shipping, shipping_cost, stock, sales, views, meli_item_id, seller_id, category_id, is_active, created_at, updated_at, product_images(url), categories:category_id(name)";
