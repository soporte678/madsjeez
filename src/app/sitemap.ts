...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    { url: BASE_URL,                                  lastModified: new Date("2026-06-01"), changeFrequency: "daily",   priority: 1.0 },
    { url: `${BASE_URL}/marketplace`,                 lastModified: new Date("2026-06-01"), changeFrequency: "daily",   priority: 0.9 },
    { url: `${BASE_URL}/categories`,                  lastModified: new Date("2026-06-01"), changeFrequency: "weekly",  priority: 0.8 },
    { url: `${BASE_URL}/sell`,                        lastModified: new Date("2026-06-01"), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${BASE_URL}/crear-tienda-online`,         lastModified: new Date("2026-06-01"), changeFrequency: "weekly",  priority: 0.9 },
    { url: `${BASE_URL}/comprar-en-madsjeez`,         lastModified: new Date("2026-06-01"), changeFrequency: "weekly",  priority: 0.85 },
    { url: `${BASE_URL}/flash`,                       lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/maqjeez-y-madsjeez`,          lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/quienes-somos`,               lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/ayuda`,                       lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...HELP_ARTICLES.map((a) => ({
    ...
    { url: `${BASE_URL}/ayuda-vendedores`,           lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/marcas`,                      lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...MARCAS.map((m) => ({
      url: `${BASE_URL}/marcas/${m.slug}`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.6,
    })),
    { url: `${BASE_URL}/comparativas`,                lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...COMPARATIVAS.map((c) => ({
    ...
    { url: `${BASE_URL}/reparacion`,                  lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...REP_GUIAS.map((g) => ({
      url: `${BASE_URL}/reparacion/${g.slug}`,
      lastModified: new Date("2026-06-01"),
      changeFrequency: "monthly" as const,
      priority: 0.6,
    })),
    { url: `${BASE_URL}/tutoriales`,                  lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.7 },
    ...TUTORIALES.map((t) => ({
    ...
    { url: `${BASE_URL}/legal/cookies`,               lastModified: new Date("2026-01-01"), changeFrequency: "yearly",  priority: 0.3 },
    { url: `${BASE_URL}/legal/reembolsos`,            lastModified: new Date("2026-01-01"), changeFrequency: "yearly",  priority: 0.3 },
    { url: `${BASE_URL}/legal/aviso-legal`,           lastModified: new Date("2026-01-01"), changeFrequency: "yearly",  priority: 0.3 },
  ];
