...
export default function VehiculosInteresPage() {
  return (
    <div className="flex-1 flex flex-col gap-6 w-full max-w-5xl">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border p-24 flex flex-col items-center justify-center text-center">
        <Car size={48} className="text-muted-foreground/40 mb-4" />
        <h3 className="text-lg font-semibold text-foreground mb-2">Todavía no guardaste vehículos</h3>
