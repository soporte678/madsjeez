...
type PublicCoupon = {
  ...
  minPurchase: Number(number
  maxDiscount: Number(number
  expiresAt: string
  store: {
    name: string
    logo: string
...
const DEMO_COUPONS: PublicCoupon[] = [
  // Electrónica, Audio y Video
  {
    ...
    discountValue: Number(5,
    minPurchase: Number(25249,
    maxDiscount: Number(21251,
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(20000,
    minPurchase: Number(200000,
    maxDiscount: Number(20000,
  ...
  // Hogar, Muebles y Jardín
  {
    ...
    discountType: "percentage",
    discountValue: Number(5,
    minPurchase: Number(61669,
    maxDiscount: Number(15405,
    expiresAt: "2026-05-31",
    store: {
      name: "GADNIC",
      logo: "https://placehold.co/50x50/2563EB/white?text=G",
  ...
  },
  {
    ...
    minPurchase: Number(50000,
    maxDiscount: Number(10000,
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(2500,
    minPurchase: Number(25000,
    maxDiscount: Number(2500,
    expiresAt: "2026-06-01",
    store: {
      name: "LOGUS",
  ...
  },
  {
    ...
    discountType: "percentage",
    discountValue: Number(5,
    minPurchase: Number(44262,
    maxDiscount: Number(15000,
    expiresAt: "2026-06-01",
    store: {
      name: "LICXV",
  ...
  },
  {
    ...
    discountType: "fixed",
    discountValue: Number(3500,
    minPurchase: Number(70000,
    maxDiscount: Number(3500,
  ...
  // Moda y Accesorios
  {
    ...
    minPurchase: Number(5000,
    maxDiscount: Number(120000,
  ...
  },
  {
    ...
    discountType: "percentage",
    discountValue: Number(5,
    minPurchase: Number(34082,
    maxDiscount: Number(8670,
    expiresAt: "2026-05-31",
    store: {
      name: "CARE GADNIC",
  ...
  },
  {
    ...
    discountType: "percentage",
    discountValue: Number(5,
    minPurchase: Number(53252,
    maxDiscount: Number(13313,
    expiresAt: "2026-05-31",
    store: {
      name: "GADNIC SPORT",
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(6000,
    minPurchase: Number(180000,
    maxDiscount: Number(6000,
    expiresAt: "2026-05-31",
    store: {
      name: "Padel Pro",
  ...
  },
  {
    ...
    discountType: "percentage",
    discountValue: Number(10,
    minPurchase: Number(100000,
    maxDiscount: Number(21000,
  ...
  },
  {
    ...
    discountType: "percentage",
    discountValue: Number(5,
    minPurchase: Number(10000,
    maxDiscount: Number(5000,
    expiresAt: "2026-06-30",
    store: {
      name: "GARIOTTI",
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(30000,
    minPurchase: Number(700000,
    maxDiscount: Number(30000,
    expiresAt: "2026-06-30",
    store: {
      name: "Go Tire Pro",
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "percentage",
    discountValue: Number(7,
    minPurchase: Number(10000,
    maxDiscount: Number(7000,
    expiresAt: "2026-06-30",
    store: {
      name: "FULL STORE",
  ...
  // Más de $5000
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(100000,
    minPurchase: Number(1000001,
    maxDiscount: Number(100000,
  ...
  },
  {
    ...
    description: "En productos seleccionados",
    discountType: "fixed",
    discountValue: Number(44000,
    minPurchase: Number(44998,
    maxDiscount: Number(44000,
    expiresAt: "2026-06-30",
    store: {
      name: "POINT Store",
    ...
    let coupons: PublicCoupon[] = usableRealCoupons.length > 0
      ? usableRealCoupons.map((coupon) => {
        ...
        return {
          ...
          maxDiscount: Number(coupon.maxDiscount || coupon.discountValue,
          expiresAt,
          store: {
