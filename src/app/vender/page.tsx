...
export const metadata: Metadata = {
  ...
  description:
    "Publicá tus productos en MadsJeez y llegá a compradores de todo el país. Sin comisiones iniciales, con pagos seguros y envíos integrados.",
  alternates: { canonical: "https://www.madsjeez.com.ar/vender" },
  openGraph: {
    title: "Vendé en MadsJeez — Marketplace Argentina",
    description:
      "Publicá tus productos y llegá a compradores de todo el país. Sin comisiones iniciales, pagos seguros y envíos integrados.",
