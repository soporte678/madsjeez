...
| Método | Ruta | Descripción | Auth |
|--------|------|-------------|------|
| GET | `/api/meli/status` | Estado de conexión / tokens. | Sesión |
| GET, POST | `/api/meli/import` | Consultar o lanzar importación de ítems. | Sesión |
| POST | `/api/meli/push-items` | Enviar o sincronizar ítems hacia ML. | Sesión |
