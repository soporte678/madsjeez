...
- [ ] **Bot WhatsApp:** Evolution → [railway-evolution-setup.md](./railway-evolution-setup.md). Ollama opcional → [railway-ollama-setup.md](./railway-ollama-setup.md); verificar `/api/seller/whatsapp-bot/health` → `ollama.ok: true`. Sin Ollama el bot usa reglas.
